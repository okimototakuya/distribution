...
class Conf():
    ...
    def __init__(self, input_z):
        ...
        self.__gauss_z_c = gauss.multidim_gauss(input_z.T, mu=np.matrix([3,3]).T, sigma=np.matrix([[1,0],[0,1]]))
        self.__Z = gauss.mixed_gauss(input_z, (self.__gauss_z_a, 2/4), (self.__gauss_z_b, 1/4), (self.__gauss_z_c, 1/4))                         # 混合率
